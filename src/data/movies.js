...
const localPoster = (title) => getPosterFallback(title);
const localBackdrop = (title) => getPosterFallback(title, { width: 1280, height: 720 });
export const movies = [
    // ========== 2025 MOVIES (NEWEST) ==========
    {
        id: 'superman-2025',
...
export const getMoviesByVerdict = (verdict) => {
...
export const getReviewByMovieId = (movieId) => {
