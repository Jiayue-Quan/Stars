        ...
        <div className="grid gap-10 lg:grid-cols-[0.95fr_0.9fr_0.9fr_1fr] lg:gap-12">
          <div>
            <Link to="/" className="group mb-5 flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl transition-all group-hover:scale-105" style={{
          ...
          <div>
            ...
            <Link to="/signup" className="mt-5 inline-flex items-center gap-2 rounded-full border border-[#d26d47]/30 bg-[#d26d47]/10 px-4 py-2 text-sm font-semibold text-white transition-all hover:border-[#d26d47]/45 hover:bg-[#d26d47]/15">
              Join the list
