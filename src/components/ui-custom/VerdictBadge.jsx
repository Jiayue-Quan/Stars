...
export function VerdictBadge({ verdict, score, size = 'md', showScore = true }) {
    const sizeClasses = {
    ...
    return (<div className="flex items-center gap-2">
      ...
      {showScore && score !== undefined && (<span className={`font-semibold text-foreground ${scoreSizeClasses[size]}`}>
          {score.toFixed(1)}/10
        </span>)}
    </div>);
}
